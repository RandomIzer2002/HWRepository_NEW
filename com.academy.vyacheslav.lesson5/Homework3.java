public class Homework3 {
	...
	public static void main(String[] args) {
		...
		Student st0 = new Student(100200, "Иванов Иван Иванович",
				"Экономика и управление", 10, 1, 2001);
		Student st1 = new Student(100201, "Евгеньев Евгений Евгеньевич",
				"Физико-технический", 15, 1, 1995);
		Student st2 = new Student(100203, "Олегов Олег Олегович",
				"Математика и информатика", 1, 3, 2001);
		Student st3 = new Student(100205, "Валентинова Валентина Валентиновна",
				"Экономика и управление", 10, 2, 2003);
		Student st4 = new Student(100210, "Александрова Александра Александровна",
				"Физико-технический", 15, 4, 1997);
		Student st5 = new Student(100100, "Петров Пётр Петрович",
				"Экономика и управление", 10, 1, 1999);
		Student st6 = new Student(100110, "Карпов Карп Карпович", "Физико-технический",
				15, 4, 1998);
		Student st7 = new Student(100120, "Павлов Павел Павлович",
				"Математика и информатика", 1, 2, 1996);
		Student st8 = new Student(100130, "Данилов Данила Данилович",
				"Физико-технический", 15, 5, 1996);
		Student st9 = new Student(100250, "Сидоров Иван Иванович",
